...
source("https://raw.githubusercontent.com/ramirobentes/NBA-in-R/master/add%20data%20pbp.R")
...
data_urls <- c("https://github.com/ramirobentes/NBA-in-R/blob/master/pbp_hoopr_2110.csv?raw=true",
...
nba_pbp_raw <- map_df(data_urls, ~ read_csv(., col_types = c(cl = "c"))) %>%
  bind_rows(pbp_month %>%
